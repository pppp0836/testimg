...
export class IvyPinch {
    ...
    handlePan = (event: any) => {
        ...
        // if (!this.stopReachEvent) {
        //     if (this.moveX === 0 || this.isReachEdge) {
        //         this.emitEvent({
        //             name: 'reachedge',
        //             detail: {
        //                 moveX: this.moveX,
    ...
    handleWheel = (event: any) => {
        ...
        const zoomFactor = event.deltaY < 0 ? (this.properties.wheelZoomFactor) : (- this.properties.wheelZoomFactor);
    ...
    transformElement(duration: any) {
        ...
        this.element.style.transform = 'matrix(' + Number(this.scale) + ', 0, 0, '
          + Number(this.scale) + ', ' + Number(this.moveX) + ', ' + Number(this.moveY) + ')';
    }
